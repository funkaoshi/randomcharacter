class CharacterClass(object):
    """
    A structure to store information about the various D&D classes.
    """
    ...
    # TODO: Add Dwarves, Elves, and Halflings
...
# add enumeration of attributes to CharacterClass structure.
# e.g. CharacterClass.STR = 0, CharacterClass.INT = 1, etc.
for i, attr in enumerate(CharacterClass.ATTRIBUTES):
    setattr(CharacterClass, attr, i)
